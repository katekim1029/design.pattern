# Chapter9. 메시징 패턴 (Messaging Patterns)
...
5. 메시지 재생 (Message replay)
6. 파이프와 필터 (Pipes and filters)

### 메시지란 무엇인가
* [Messaging patterns in JavaScript](https://dev.to/krissiegel/messaging-patterns-in-javascript)
...
```
eg. [fanoutin.html](./src/fanoutin.html)

### 메시지 버전 관리 (Versioning messages)
```js
module Login{
